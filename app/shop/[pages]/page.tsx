...
export default function PageDetails({ params }) {
  ...
  return (
    <div>
      <br />
      <br />
      {params.pages == "prints" && (<div className="text-center text-white text-xl font-bold">To see all 3D Print colours, <span className="text-[#cb18db] cursor-pointer underline underline-offset-2"><Link href={"/printcolours"}>click here</Link></span></div>)}
      <br />
      <br />
      <div className="flex justify-center">
